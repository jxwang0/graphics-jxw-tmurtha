...
SystemSettings.mySystem = {
    ...
    initializerFunction : SphereInitializer,
    initializerSettings : {
        sphere: new THREE.Vector4 ( 0.0, 0.0, 0.0, 22.0),
        color:    new THREE.Vector4 ( 1.0, 1.0, 1.0, 1.0 ),
        lifetime: 6,
        size:     2.5,
    },
    ...
    updaterSettings : {
        externalForces : {
            gravity :     new THREE.Vector3( 0, 0, 0),
            attractors : [new THREE.Sphere( new THREE.Vector3(60.0, 0, -60.0), RAD ), new THREE.Sphere( new THREE.Vector3(60.0, 0, 60.0), RAD ), new THREE.Sphere( new THREE.Vector3(-60.0, 0, 60.0), RAD ), new THREE.Sphere( new THREE.Vector3(-60.0, 0, -60.0), RAD )  ],
